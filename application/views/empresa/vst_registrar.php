...
<html lang="es">
    ...
    <body>
        ...
        <section class="ingreso1" style="margin-top: 60px;float: right; margin-left: 100px;">
            ...
            <?php echo form_open('ctl_login_empresa/registrarempresa',"class='key-cloud2' id='Form-SignUp' name='form' style='margin-top:30px;margin-left:40px;width:40%;float:right;'")?>
                ...
                <table>
                    <tbody>
                                        <tr id="rutUser">
                                            <td>
                                                <input type="text" name="rutEmpresa" value="" placeholder="Ingresa RUT EMPRESA" size="50" id="rutt">
                                            </td> 
                                            <td>(*)</td>
                                        </tr>
                                        <tr id="nombreEmpresa">
                                            <td>
                                                <input type="text" name="razonsocialEmpresa" value="" placeholder="Ingresa Razón Social" size="50">
                                            </td> 
                                            <td>(*)</td>
                                        </tr>
                                        <tr id="rutUser">
